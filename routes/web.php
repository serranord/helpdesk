...
Route::middleware(['auth'])->group(function () {
    ...
    // Transparencia TI — accesible para todos
    Route::get('/estado-servicio', [TransparenciaController::class, 'index'])->name('transparencia.index');

    // Tickets
    Route::get ('/tickets',                       [TicketController::class, 'index'])->name('tickets.index');
    Route::get ('/tickets/trabajando-hoy',        [TicketController::class, 'trabajandoHoy'])->name('tickets.trabajando-hoy');
    Route::post('/tickets/{ticket}/trabajando-hoy/toggle', [TicketController::class, 'toggleTrabajandoHoy'])->name('tickets.trabajando-hoy.toggle');
    Route::post('/tickets/trabajando-hoy/orden',  [TicketController::class, 'ordenarTrabajandoHoy'])->name('tickets.trabajando-hoy.orden');
